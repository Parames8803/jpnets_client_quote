...
export default function RootLayout() {
  ...
  if (!appReady || !loaded) {
    // Show custom splash screen until app is ready and fonts are loaded
  ...
  return (
    <ThemeProvider value={colorScheme === "dark" ? DarkTheme : DefaultTheme}>
      ...
      >
        ...
        <Stack.Screen
          name="quotation/[id]"
          options={{ title: "Manage Quotation" }}
        />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          name="settings/manage-room-types"
          options={{ title: "Manage Room Types" }}
        />
        <Stack.Screen
